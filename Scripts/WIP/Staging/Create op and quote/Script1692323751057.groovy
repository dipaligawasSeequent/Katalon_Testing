...
WebUI.callTestCase(findTestCase('WIP/Staging/login into salesforce with general testing user stg'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.maximizeWindow()

WebUI.callTestCase(findTestCase('WIP/Staging/Data_02_Select account url in stg'), [:], FailureHandling.STOP_ON_FAILURE)
